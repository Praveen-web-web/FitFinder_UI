              ...
              <Card className="border-2 hover:shadow-xl transition-all">
                <CardHeader className="pb-3">
                  <div className="flex items-start gap-3">
                    ...
                    <CardTitle className="text-base sm:text-lg">How do I register as a student?</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Click on "Get Started" or "Register" button, select the Student tab, and fill in your details to create an account.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 hover:shadow-xl transition-all">
                <CardHeader className="pb-3">
                  <div className="flex items-start gap-3">
                    ...
                    <CardTitle className="text-base sm:text-lg">How can companies access reports?</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Companies need to register first. Once approved, you can log in and access detailed reports of all shortlisted candidates.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 hover:shadow-xl transition-all">
                <CardHeader className="pb-3">
                  <div className="flex items-start gap-3">
                    ...
                    <CardTitle className="text-base sm:text-lg">What is the filtering process?</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Students are filtered based on predefined criteria such as education, skills, and experience before being eligible for tests.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 hover:shadow-xl transition-all">
                <CardHeader className="pb-3">
                  <div className="flex items-start gap-3">
                    ...
                    <CardTitle className="text-base sm:text-lg">How long does it take to get results?</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Test results and reports are generated immediately after test completion and are available to both students and companies.
                  </p>
                </CardContent>
              </Card>
            </div>
