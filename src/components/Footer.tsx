    ...
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white mt-20">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none">
        <svg className="relative block w-full h-12 md:h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" fill="#f8f9ff"></path>
        </svg>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-gradient-to-r hover:from-primary hover:to-accent transition-all flex items-center justify-center group"
                title="Facebook"
                aria-label="Facebook"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg mb-4 bg-gradient-to-r from-accent to-secondary bg-clip-text text-transparent">Services</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-lg mb-4 bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent">Get in Touch</h3>
