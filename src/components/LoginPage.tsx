      ...
      <div className="container mx-auto px-4">
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-6 md:mb-8 space-y-3">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              Welcome Back
            </h1>
          ...
          <Tabs defaultValue="student" className="w-full">
            <TabsList className="grid w-full grid-cols-2 p-1 bg-muted/50 h-auto">
              <TabsTrigger 
                value="student" 
                className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 py-2 sm:py-3 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-primary/90 data-[state=active]:text-white"
              >
              ...
              <TabsTrigger 
                value="company"
                className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 py-2 sm:py-3 data-[state=active]:bg-gradient-to-r data-[state=active]:from-accent data-[state=active]:to-accent/90 data-[state=active]:text-white"
              >
            ...
            <TabsContent value="student" className="mt-6">
              <Card className="border-2 shadow-xl">
                <CardHeader className="space-y-2 pb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-primary to-primary/70 rounded-xl flex items-center justify-center mb-2">
            ...
            <TabsContent value="company" className="mt-6">
              <Card className="border-2 shadow-xl">
                <CardHeader className="space-y-2 pb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-accent to-accent/70 rounded-xl flex items-center justify-center mb-2">
            ...
            <TabsContent value="admin" className="mt-6">
              <Card className="border-2 shadow-xl">
                <CardHeader className="space-y-2 pb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-secondary to-secondary/70 rounded-xl flex items-center justify-center mb-2">
